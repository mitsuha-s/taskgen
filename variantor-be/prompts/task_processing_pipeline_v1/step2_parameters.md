Я отправляю тебе задание из школьной проверочной по английскому языку в виде html заголовка второго уровня. По данным из файла определи параметры, которые я опишу ниже. Выбери один вариант из списка возможных значений (если они указаны), если значение параметра определить не удалось используй "*".

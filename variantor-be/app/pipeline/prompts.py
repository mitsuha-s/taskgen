...
class PromptSet:
    def __init__(self, directory: str):
        ...
        self.is_json_pipeline = "json_from_image" in files
        self._source_from_image = self._read(files.get("json_from_image") or files["html_from_image"])
    ...
    def html_from_image_prompt(self) -> str:
        return self.source_from_image_prompt()

    def source_from_image_prompt(self, subject: str = "*") -> str:
        return self._render(self._source_from_image, {"Subject": subject})

    def parameters_prompt(self, task_html: str) -> str:
        return self._render(self._parameters, {"TaskHTML": task_html, "TaskJson": task_html, "Subject": "*"})
    ...
    def generation_prompt(self, task_html: str, params: dict, user_comment: str = "") -> str:
        ...
        return self._render(
            self._generation,
            {
                ...
                "Subject": value_or_star(params.get("subject")),
            },
        )
...
def format_task_parameters(params: dict) -> str:
    return "\n".join(
        [
            ...
            "Предмет: " + value_or_star(params.get("subject")),
